...
function Home() {
  return (
    <Layout>
      {/* SIMPLE HERO */}
      <section className="relative min-h-screen flex items-center justify-center bg-[color:var(--color-ink-deep)] overflow-hidden">
        <div className="max-w-4xl mx-auto px-8 md:px-12 text-center">
          ...
          >
            <span className="eyebrow text-[0.6rem] text-[color:var(--color-gold)]">
              Thought Leadership
            </span>
            <h1 className="font-serif font-bold text-[3rem] md:text-[4rem] lg:text-[4.5rem] text-white leading-[1.2] tracking-tight mt-6">
              Strategic Legal Counsel for India's Business.
            </h1>
            <p className="mt-10 text-[1rem] leading-[1.8] text-[color:var(--color-text-muted)] max-w-2xl mx-auto">
              We combine century-old legal tradition with pragmatic commercial solutions. Counsel you can trust.
            </p>
            <div className="mt-14 flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-3 border border-[color:var(--color-gold)] text-[color:var(--color-gold)] font-semibold tracking-widest uppercase text-[0.75rem] hover:bg-[color:var(--color-gold)] hover:text-[color:var(--color-ink-deep)] transition-all duration-300">
                Explore Expertise →
              </button>
              <button className="px-8 py-3 bg-[color:var(--color-gold)] text-[color:var(--color-ink-deep)] font-semibold tracking-widest uppercase text-[0.75rem] hover:bg-[color:var(--color-gold-deep)] transition-all duration-300">
                Book Consultation →
              </button>
            </div>
          </motion.div>
          ...
          >
            <span className="eyebrow text-[0.5rem] text-[color:var(--color-gold)]/50">Scroll</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="h-8 w-px bg-gradient-to-b from-[color:var(--color-gold)] to-transparent"
            />
          </motion.div>
        </div>
      </section>
